...
/************/
#ifdef MV632X
#define BUILD_TAG  "0.0.1"
#ifdef CONFIG_MV78200
#define CONFIG_IDENT_STRING	" Marvell version: 0.0.1 - Dual CPU"
#else
#define CONFIG_IDENT_STRING	" Marvell version: 0.0.1"
#endif

/* version number passing when loading Kernel */
#define VER_NUM 0x00000100           /* 0.0.1 */
#else
#define BUILD_TAG  "3.3.24"
#ifdef CONFIG_MV78200
#define CONFIG_IDENT_STRING	" Marvell version: 3.3.24 - Dual CPU"
#else
#define CONFIG_IDENT_STRING	" Marvell version: 3.3.24"
#endif

/* version number passing when loading Kernel */
#define VER_NUM 0x03031800           /* 3.3.24 */
#endif
