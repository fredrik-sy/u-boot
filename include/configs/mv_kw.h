...
/* SSS DEFINE */
/**************/
#define SSS_ETHADDR             "00:E0:91:81:DD:C0"
#define SSS_ETH1ADDR    "00:E0:91:00:00:01"
#define SSS_IPADDR              192.168.1.100
#define SSS_SERVERIP    192.168.1.101
#define SSS_BOOTDELAY   2
#define SSS_ROOTPATH    /opt/Orion-SDK/arm/
#define SSS_USB_HOST
...
/************/
#ifdef MV_TINY_IMAGE
#define CONFIG_IDENT_STRING	" Marvell version: 3.4.18-TINY"
#else
#define CONFIG_IDENT_STRING	" LGE version: NT1 Series"
#endif /* MV_TINY_IMAGE */
/* version number passing when loading Kernel */
#define VER_NUM 0x03041200           /* 3.4.18 */
...
#define	CFG_PROMPT	"LGE-NAS>> "	/* Monitor Command Prompt	*/
...
#define CONFIG_SERVERIP		10.177.191.39
#define CONFIG_NETMASK		255.255.255.0
#endif

#define ETHADDR          	"00:00:00:00:AB:CD"
#define ETH1ADDR          	"00:00:00:00:EF:01"
...
#define CONFIG_ROOTPATH	/opt/Orion-SDK/armel-2.0/rootfs
...
#define CFG_I2C_PROBES  {0x32,0x58} /* boareep, rtc, micom */
...
#define MONITOR_HEADER_LEN	0x200
 ...
 #else
  	//#define CFG_MONITOR_LEN			(512 << 10)	/* Reserve 512 kB for Monitor */
  	#define CFG_MONITOR_LEN			(0x78000)	/* Reserve 512 kB for Monitor */
 #endif								 
