...
pci_init_board(void)
{
	...
	{
		i = MV_REG_READ(PEX_CFG_DIRECT_ACCESS(pciIf, PEX_DEVICE_AND_VENDOR_ID));
		i &= ~PXDAVI_DEV_ID_MASK;

#if defined(MV76100)
		i |= (MV_76100_DEV_ID << PXDAVI_DEV_ID_OFFS);
#else
#if defined(MV78XX0) && !defined(MV78200)
		i |= (MV_78100_DEV_ID << PXDAVI_DEV_ID_OFFS);
#endif
#if defined(MV78200)
		i |= (MV_78200_DEV_ID << PXDAVI_DEV_ID_OFFS);
#endif
#endif
		MV_REG_WRITE(PEX_CFG_DIRECT_ACCESS(pciIf, PEX_DEVICE_AND_VENDOR_ID), i);
	}
#endif
